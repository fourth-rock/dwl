/* mars' dwl */
/* patches: bar, rotate clients, vanity-gaps */
...
static const int bypass_surface_visibility = 0;  /* idle inhibitors work only when their surface is visible */
...
/* Available send-events modes:
 * LIBINPUT_CONFIG_SEND_EVENTS_ENABLED
 * LIBINPUT_CONFIG_SEND_EVENTS_DISABLED
 * LIBINPUT_CONFIG_SEND_EVENTS_DISABLED_ON_EXTERNAL_MOUSE */
static const uint32_t send_events_mode = LIBINPUT_CONFIG_SEND_EVENTS_ENABLED;

/* Available acceleration profiles:
...
/* Available tap maps:
 * LIBINPUT_CONFIG_TAP_MAP_LRM -- 1/2/3 fingers map to left/right/middle
 * LIBINPUT_CONFIG_TAP_MAP_LMR -- 1/2/3 fingers map to left/middle/right */
...
static const char *menucmd[] = {
	"wmenu-run",
	"-f", "JetBrainsMono Nerd Font 13", "-l", "10",
	NULL
};
